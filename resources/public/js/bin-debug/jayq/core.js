...
;
jQuery.prototype.apply = (function (self__,args4401){
...
var hide__delegate = function ($elem,p__4403){
var vec__4405 = p__4403;
var speed = cljs.core.nth.call(null,vec__4405,0,null);
var on_finish = cljs.core.nth.call(null,vec__4405,1,null);
return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__4403 = null;
if (arguments.length > 1) {
  p__4403 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return hide__delegate.call(this, $elem, p__4403);
};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__4406){
var $elem = cljs.core.first(arglist__4406);
var p__4403 = cljs.core.rest(arglist__4406);
return hide__delegate($elem, p__4403);
});
...
var show__delegate = function ($elem,p__4407){
var vec__4409 = p__4407;
var speed = cljs.core.nth.call(null,vec__4409,0,null);
var on_finish = cljs.core.nth.call(null,vec__4409,1,null);
return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__4407 = null;
if (arguments.length > 1) {
  p__4407 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return show__delegate.call(this, $elem, p__4407);
};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__4410){
var $elem = cljs.core.first(arglist__4410);
var p__4407 = cljs.core.rest(arglist__4410);
return show__delegate($elem, p__4407);
});
...
var toggle__delegate = function ($elem,p__4411){
var vec__4413 = p__4411;
var speed = cljs.core.nth.call(null,vec__4413,0,null);
var on_finish = cljs.core.nth.call(null,vec__4413,1,null);
return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__4411 = null;
if (arguments.length > 1) {
  p__4411 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return toggle__delegate.call(this, $elem, p__4411);
};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__4414){
var $elem = cljs.core.first(arglist__4414);
var p__4411 = cljs.core.rest(arglist__4414);
return toggle__delegate($elem, p__4411);
});
...
var fade_out__delegate = function ($elem,p__4415){
var vec__4417 = p__4415;
var speed = cljs.core.nth.call(null,vec__4417,0,null);
var on_finish = cljs.core.nth.call(null,vec__4417,1,null);
return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__4415 = null;
if (arguments.length > 1) {
  p__4415 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_out__delegate.call(this, $elem, p__4415);
};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__4418){
var $elem = cljs.core.first(arglist__4418);
var p__4415 = cljs.core.rest(arglist__4418);
return fade_out__delegate($elem, p__4415);
});
...
var fade_in__delegate = function ($elem,p__4419){
var vec__4421 = p__4419;
var speed = cljs.core.nth.call(null,vec__4421,0,null);
var on_finish = cljs.core.nth.call(null,vec__4421,1,null);
return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__4419 = null;
if (arguments.length > 1) {
  p__4419 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_in__delegate.call(this, $elem, p__4419);
};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__4422){
var $elem = cljs.core.first(arglist__4422);
var p__4419 = cljs.core.rest(arglist__4422);
return fade_in__delegate($elem, p__4419);
});
...
var slide_up__delegate = function ($elem,p__4423){
...
return slide_up__delegate.call(this, $elem, p__4423);
};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__4426){
var $elem = cljs.core.first(arglist__4426);
var p__4423 = cljs.core.rest(arglist__4426);
return slide_up__delegate($elem, p__4423);
});
...
var slide_down__delegate = function ($elem,p__4427){
...
return slide_down__delegate.call(this, $elem, p__4427);
};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__4430){
var $elem = cljs.core.first(arglist__4430);
var p__4427 = cljs.core.rest(arglist__4430);
return slide_down__delegate($elem, p__4427);
});
...
var closest__delegate = function ($elem,selector,p__4431){
var vec__4433 = p__4431;
var context = cljs.core.nth.call(null,vec__4433,0,null);
return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__4431 = null;
if (arguments.length > 2) {
  p__4431 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return closest__delegate.call(this, $elem, selector, p__4431);
};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__4434){
var $elem = cljs.core.first(arglist__4434);
arglist__4434 = cljs.core.next(arglist__4434);
var selector = cljs.core.first(arglist__4434);
var p__4431 = cljs.core.rest(arglist__4434);
return closest__delegate($elem, selector, p__4431);
});
...
inner.cljs$core$IFn$_invoke$arity$1 = inner__1;
inner.cljs$core$IFn$_invoke$arity$2 = inner__2;
return inner;
})()
;
...
jayq.core.preprocess_request = (function preprocess_request(p__4437){
...
var request = map__4439__$1;
var contentType = cljs.core.get.call(null,map__4439__$1,"\uFDD0:contentType");
var data = cljs.core.get.call(null,map__4439__$1,"\uFDD0:data");
var ct = jayq.core.__GT_content_type.call(null,contentType);
return (function (p1__4436_SHARP_){
if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__4436_SHARP_,"\uFDD0:data",cljs.core.pr_str.call(null,data));
} else
{return p1__4436_SHARP_;
}
}).call(null,(function (p1__4435_SHARP_){
if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__4435_SHARP_,"\uFDD0:contentType",ct);
} else
{return p1__4435_SHARP_;
}
}).call(null,request));
});
...
;
jayq.core.xhr = (function xhr(p__4440,content,callback){
var vec__4442 = p__4440;
var method = cljs.core.nth.call(null,vec__4442,0,null);
var uri = cljs.core.nth.call(null,vec__4442,1,null);
...
var unbind__delegate = function ($elem,ev,p__4443){
var vec__4445 = p__4443;
var func = cljs.core.nth.call(null,vec__4445,0,null);
return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__4443 = null;
if (arguments.length > 2) {
  p__4443 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return unbind__delegate.call(this, $elem, ev, p__4443);
};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__4446){
var $elem = cljs.core.first(arglist__4446);
arglist__4446 = cljs.core.next(arglist__4446);
var ev = cljs.core.first(arglist__4446);
var p__4443 = cljs.core.rest(arglist__4446);
return unbind__delegate($elem, ev, p__4443);
});
...
var on__delegate = function ($elem,events,p__4447){
var vec__4449 = p__4447;
var sel = cljs.core.nth.call(null,vec__4449,0,null);
var data = cljs.core.nth.call(null,vec__4449,1,null);
var handler = cljs.core.nth.call(null,vec__4449,2,null);
return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__4447 = null;
if (arguments.length > 2) {
  p__4447 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return on__delegate.call(this, $elem, events, p__4447);
};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__4450){
var $elem = cljs.core.first(arglist__4450);
arglist__4450 = cljs.core.next(arglist__4450);
var events = cljs.core.first(arglist__4450);
var p__4447 = cljs.core.rest(arglist__4450);
return on__delegate($elem, events, p__4447);
});
...
var one__delegate = function ($elem,events,p__4451){
var vec__4453 = p__4451;
var sel = cljs.core.nth.call(null,vec__4453,0,null);
var data = cljs.core.nth.call(null,vec__4453,1,null);
var handler = cljs.core.nth.call(null,vec__4453,2,null);
...
return one__delegate.call(this, $elem, events, p__4451);
};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__4454){
var $elem = cljs.core.first(arglist__4454);
arglist__4454 = cljs.core.next(arglist__4454);
var events = cljs.core.first(arglist__4454);
var p__4451 = cljs.core.rest(arglist__4454);
return one__delegate($elem, events, p__4451);
});
...
var off__delegate = function ($elem,events,p__4455){
var vec__4457 = p__4455;
var sel = cljs.core.nth.call(null,vec__4457,0,null);
var handler = cljs.core.nth.call(null,vec__4457,1,null);
return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__4455 = null;
if (arguments.length > 2) {
  p__4455 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return off__delegate.call(this, $elem, events, p__4455);
};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__4458){
var $elem = cljs.core.first(arglist__4458);
arglist__4458 = cljs.core.next(arglist__4458);
var events = cljs.core.first(arglist__4458);
var p__4455 = cljs.core.rest(arglist__4458);
return off__delegate($elem, events, p__4455);
});
...
done.cljs$lang$applyTo = (function (arglist__4459){
var deferred = cljs.core.first(arglist__4459);
var fns_args = cljs.core.rest(arglist__4459);
...
fail.cljs$lang$applyTo = (function (arglist__4460){
var deferred = cljs.core.first(arglist__4460);
var fns_args = cljs.core.rest(arglist__4460);
...
always.cljs$lang$applyTo = (function (arglist__4461){
var deferred = cljs.core.first(arglist__4461);
var fns_args = cljs.core.rest(arglist__4461);
