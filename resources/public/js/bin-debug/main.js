...
cljs.core.with_meta = function with_meta(b, c) {
  ...
  return d ? with_meta.call(null, function() {
    if(void 0 === cljs.core.t3625) {
      cljs.core.t3625 = {};
      cljs.core.t3625 = function(b, c, d, e) {
        this.meta = b;
        this.o = c;
        this.with_meta = d;
        this.meta3626 = e;
      ...
      cljs.core.t3625.cljs$lang$type = !0;
      cljs.core.t3625.cljs$lang$ctorStr = "cljs.core/t3625";
      cljs.core.t3625.cljs$lang$ctorPrWriter = function(b, c) {
        return cljs.core._write.call(null, c, "cljs.core/t3625")
      };
      var d = cljs.core.t3625.prototype, f = function(b, c) {
      ...
      d.call = g;
      cljs.core.t3625.prototype.apply = function(b, c) {
        b = this;
        return b.call.apply(b, [b].concat(c.slice()))
      };
      cljs.core.t3625.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3625.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3626
      };
      cljs.core.t3625.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
        return new cljs.core.t3625(this.meta, this.o, this.with_meta, c)
      }
    }
    return new cljs.core.t3625(c, b, with_meta, null)
...
var promise_stream = {pcell:{}};
promise_stream.pcell.deferred = function(a) {
  return jayq.core.resolve.call(null, jayq.core.$deferred.call(null), a)
};
promise_stream.pcell.PCell = function(a) {
  this.deferred_wrapping_cell = a
};
promise_stream.pcell.PCell.cljs$lang$type = !0;
promise_stream.pcell.PCell.cljs$lang$ctorStr = "promise-stream.pcell/PCell";
promise_stream.pcell.PCell.cljs$lang$ctorPrWriter = function(a, b) {
  return cljs.core._write.call(null, b, "promise-stream.pcell/PCell")
};
promise_stream.pcell.closed_container = function(a) {
  return new promise_stream.pcell.PCell(promise_stream.pcell.deferred.call(null, a))
};
promise_stream.pcell.open_container = function() {
  return new promise_stream.pcell.PCell(jayq.core.$deferred.call(null))
};
promise_stream.pcell.empty_cell = function() {
  return promise_stream.pcell.closed_container.call(null, null)
};
promise_stream.pcell.open_cell = function(a) {
  return promise_stream.pcell.closed_container.call(null, cljs.core.cons.call(null, a, promise_stream.pcell.open_container.call(null)))
};
promise_stream.pcell.closed_cell = function(a, b) {
  return promise_stream.pcell.closed_container.call(null, cljs.core.cons.call(null, a, b))
};
promise_stream.pcell.done = function(a, b) {
  return jayq.core.done.call(null, a.deferred_wrapping_cell, b)
};
promise_stream.pcell.resolve = function(a, b) {
  return jayq.core.resolve.call(null, a.deferred_wrapping_cell, b)
};
promise_stream.pcell.PCell.prototype.cljs$core$ISeqable$ = !0;
promise_stream.pcell.PCell.prototype.cljs$core$ISeqable$_seq$arity$1 = function(a) {
  return a
};
promise_stream.pcell.PCell.prototype.cljs$core$ISeq$ = !0;
promise_stream.pcell.PCell.prototype.cljs$core$ISeq$_first$arity$1 = function(a) {
  var b = jayq.core.$deferred.call(null);
  promise_stream.pcell.done.call(null, a, function(a) {
    return jayq.core.resolve.call(null, b, cljs.core.first.call(null, a))
  });
  return jayq.core.promise.call(null, b)
};
promise_stream.pcell.PCell.prototype.cljs$core$ISeq$_rest$arity$1 = function(a) {
  var b = jayq.core.$deferred.call(null);
  promise_stream.pcell.done.call(null, a, function(a) {
    var d = cljs.core.rest.call(null, a);
    return cljs.core.empty_QMARK_.call(null, d) ? jayq.core.resolve.call(null, b, null) : promise_stream.pcell.done.call(null, cljs.core.rest.call(null, a), function(a) {
      return jayq.core.resolve.call(null, b, a)
    })
  });
  return new promise_stream.pcell.PCell(b)
};
promise_stream.pcell.dapply = function(a) {
  var b = null;
  return b = function(b, d) {
    switch(arguments.length) {
      case 0:
        return promise_stream.pcell.deferred.call(null, a.call(null));
      case 1:
        var e = jayq.core.$deferred.call(null);
        jayq.core.done.call(null, b, function(b) {
          return jayq.core.resolve.call(null, e, a.call(null, b))
        });
        return e;
      case 2:
        var f = jayq.core.$deferred.call(null);
        jayq.core.done.call(null, b, function(b) {
          return jayq.core.done.call(null, d, function(c) {
            return jayq.core.resolve.call(null, f, a.call(null, b, c))
          })
        });
        return f
    }
...
promise_stream.pstream.closed_pstream = function() {
  var a = function(a) {
    return cljs.core.reduce.call(null, function(a, b) {
      return promise_stream.pcell.closed_cell.call(null, b, a)
    }, promise_stream.pcell.empty_cell.call(null), cljs.core.reverse.call(null, a))
  }, b = function(b) {
    var d = null;
    0 < arguments.length && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
promise_stream.pstream.reduce_STAR_ = function reduce_STAR_(b, c, d, e) {
  var f = d.call(null, e, cljs.core.first.call(null, c)), g = cljs.core.rest.call(null, c);
  return promise_stream.pcell.done.call(null, g, function(c) {
    return cljs.core.empty_QMARK_.call(null, c) ? jayq.core.done.call(null, f, function(c) {
      return jayq.core.resolve.call(null, b, c)
    }) : reduce_STAR_.call(null, b, g, d, f)
  })
};
promise_stream.pcell.PCell.prototype.cljs$core$IReduce$ = !0;
promise_stream.pcell.PCell.prototype.cljs$core$IReduce$_reduce$arity$2 = function(a, b) {
  return cljs.core._reduce.call(null, cljs.core.rest.call(null, a), b, cljs.core.first.call(null, a))
};
promise_stream.pcell.PCell.prototype.cljs$core$IReduce$_reduce$arity$3 = function(a, b, c) {
  var d = jayq.core.$deferred.call(null);
  promise_stream.pstream.reduce_STAR_.call(null, d, a, b, c);
  return d
};
promise_stream.pstream.open_pstream = function() {
  var a = function(a) {
    var b = promise_stream.pcell.open_container.call(null), a = cljs.core.reduce.call(null, function(a, b) {
      return promise_stream.pcell.closed_cell.call(null, b, a)
    }, b, a);
    return cljs.core.list.call(null, a, cljs.core.atom.call(null, b))
  }, b = function(b) {
    var d = null;
    0 < arguments.length && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
promise_stream.pstream.append_BANG_ = function(a, b) {
  var c = cljs.core.deref.call(null, a), d = promise_stream.pcell.open_container.call(null);
  jayq.core.done.call(null, b, function(a) {
    a = cljs.core.cons.call(null, a, d);
    return promise_stream.pcell.resolve.call(null, c, a)
  });
  cljs.core.reset_BANG_.call(null, a, d);
  return a
};
promise_stream.pstream.close_BANG_ = function(a) {
  return promise_stream.pcell.resolve.call(null, cljs.core.deref.call(null, a), null)
};
promise_stream.pstream.traverse = function() {
  var a = null, b = function(b, c, f) {
    return promise_stream.pcell.done.call(null, b, function(b) {
      if(cljs.core.empty_QMARK_.call(null, b)) {
        return f.call(null)
      }
      c.call(null, cljs.core.first.call(null, b));
      return a.call(null, cljs.core.rest.call(null, b), c, f)
    })
  }, c = function(b, c, f, g) {
    return promise_stream.pcell.done.call(null, b, function(h) {
      return promise_stream.pcell.done.call(null, c, function(i) {
        var j;
        j = (j = cljs.core.empty_QMARK_.call(null, h)) ? j : cljs.core.empty_QMARK_.call(null, i);
        if(j) {
          return g.call(null)
        }
        f.call(null, cljs.core.first.call(null, h), cljs.core.first.call(null, i));
        return a.call(null, cljs.core.rest.call(null, b), cljs.core.rest.call(null, c), f, g)
      })
    })
  }, a = function(a, e, f, g) {
    switch(arguments.length) {
...
promise_stream.pstream.with_open_pstream = function(a) {
  var b = promise_stream.pstream.open_pstream.call(null), c = cljs.core.nth.call(null, b, 0, null), b = cljs.core.nth.call(null, b, 1, null);
  a.call(null, b);
  return c
};
promise_stream.pstream.modifying_appender = function(a, b) {
  return function(c) {
    return promise_stream.pstream.append_BANG_.call(null, a, b.call(null, c))
  }
};
promise_stream.pstream.closer = function(a) {
  return function() {
    return promise_stream.pstream.close_BANG_.call(null, a)
  }
};
promise_stream.pstream.map_STAR_ = function(a, b) {
  return promise_stream.pstream.with_open_pstream.call(null, function(c) {
    return promise_stream.pstream.traverse.call(null, b, promise_stream.pstream.modifying_appender.call(null, c, a), promise_stream.pstream.closer.call(null, c))
  })
};
promise_stream.pstream.mapd_STAR_ = function(a, b) {
  return promise_stream.pstream.map_STAR_.call(null, cljs.core.comp.call(null, promise_stream.pcell.deferred, a), b)
};
promise_stream.pstream.close_if_complete = function(a, b, c) {
  return function() {
    cljs.core.swap_BANG_.call(null, a, cljs.core.inc);
    return cljs.core._EQ_.call(null, cljs.core.deref.call(null, b), cljs.core.deref.call(null, a)) ? promise_stream.pstream.close_BANG_.call(null, c) : null
  }
};
promise_stream.pstream.co_operative_close = function(a, b, c) {
  var d = cljs.core.atom.call(null, null), e = cljs.core.atom.call(null, 0), b = promise_stream.pstream.close_if_complete.call(null, e, d, b);
  jayq.core.done.call(null, a, function(a) {
...
promise_stream.pstream.concat_STAR_ = function() {
  var a = function(a) {
    return promise_stream.pstream.with_open_pstream.call(null, function(b) {
      return promise_stream.pstream.co_operative_close.call(null, promise_stream.pcell.deferred.call(null, cljs.core.count.call(null, a)), b, function(e) {
        return cljs.core.doall.call(null, cljs.core.map.call(null, function(a) {
          return promise_stream.pstream.traverse.call(null, a, promise_stream.pstream.modifying_appender.call(null, b, promise_stream.pcell.deferred), e)
        }, a))
      })
    })
  }, b = function(b) {
...
promise_stream.pstream.count_STAR_ = function(a) {
  return cljs.core.reduce.call(null, promise_stream.pcell.dapply.call(null, function(a) {
    return a + 1
  }), promise_stream.pcell.deferred.call(null, 0), a)
};
promise_stream.pstream.mapcat_STAR_ = function(a, b) {
  return promise_stream.pstream.with_open_pstream.call(null, function(c) {
    return promise_stream.pstream.co_operative_close.call(null, promise_stream.pstream.count_STAR_.call(null, b), c, function(d) {
      var e = promise_stream.pstream.map_STAR_.call(null, cljs.core.comp.call(null, promise_stream.pcell.deferred, a), b);
      return promise_stream.pstream.map_STAR_.call(null, function(a) {
        return promise_stream.pstream.traverse.call(null, a, promise_stream.pstream.modifying_appender.call(null, c, promise_stream.pcell.deferred), d)
      }, e)
    })
  })
};
promise_stream.pstream.pair_adder = function(a) {
  return function(b, c) {
    return promise_stream.pstream.append_BANG_.call(null, a, promise_stream.pstream.promise.call(null, cljs.core.list.call(null, b, c)))
  }
};
promise_stream.pstream.zip_STAR_ = function(a, b) {
  return promise_stream.pstream.with_open_pstream.call(null, function(c) {
    return promise_stream.pstream.traverse.call(null, a, b, promise_stream.pstream.pair_adder.call(null, c), promise_stream.pstream.closer.call(null, c))
  })
};
promise_stream.pstream.conditional_adder = function(a, b) {
  return function(c) {
    return jayq.core.done.call(null, a.call(null, c), function(a) {
      return cljs.core.truth_(a) ? promise_stream.pstream.append_BANG_.call(null, b, promise_stream.pstream.promise.call(null, c)) : null
    })
  }
};
promise_stream.pstream.filter_STAR_ = function(a, b) {
  return promise_stream.pstream.with_open_pstream.call(null, function(c) {
    return promise_stream.pstream.traverse.call(null, b, promise_stream.pstream.conditional_adder.call(null, a, c), promise_stream.pstream.closer.call(null, c))
  })
};
promise_stream.pstream.rests_STAR_ = function() {
  var a = null, b = function(b) {
    return promise_stream.pstream.with_open_pstream.call(null, function(c) {
      promise_stream.pstream.append_BANG_.call(null, c, promise_stream.pstream.promise.call(null, b));
      return a.call(null, c, b)
    })
  }, c = function(b, c) {
    return promise_stream.pcell.done.call(null, c, function(c) {
      if(cljs.core.empty_QMARK_.call(null, c)) {
        return promise_stream.pstream.close_BANG_.call(null, b)
      }
      c = cljs.core.rest.call(null, c);
      promise_stream.pstream.append_BANG_.call(null, b, promise_stream.pstream.promise.call(null, c));
      return a.call(null, b, c)
    })
  }, a = function(a, e) {
    switch(arguments.length) {
...
promise_stream.pstream.resolves_within_QMARK_ = function(a, b) {
  var c = jayq.core.$deferred.call(null);
  setTimeout(function() {
    return jayq.core.resolve.call(null, c, !1)
  }, a);
  promise_stream.pcell.done.call(null, b, function() {
    return jayq.core.resolve.call(null, c, !0)
  });
  return c
};
promise_stream.pstream.after_resolver = function(a) {
  return function(b) {
    cljs.core.nth.call(null, b, 0, null);
    b = cljs.core.nth.call(null, b, 1, null);
    return promise_stream.pstream.fmap.call(null, cljs.core.not).call(null, promise_stream.pstream.resolves_within_QMARK_.call(null, a, b))
  }
};
promise_stream.pstream.throttle_STAR_ = function(a, b) {
  return promise_stream.pstream.mapd_STAR_.call(null, cljs.core.first, promise_stream.pstream.filter_STAR_.call(null, promise_stream.pstream.after_resolver.call(null, a), promise_stream.pstream.zip_STAR_.call(null, b, cljs.core.rest.call(null, promise_stream.pstream.rests_STAR_.call(null, b)))))
};
promise_stream.pstream.reductions_STAR_ = function() {
  var a = null, b = function(b, c) {
    return a.call(null, b, cljs.core.first.call(null, c), cljs.core.rest.call(null, c))
  }, c = function(b, c, d) {
    return promise_stream.pstream.with_open_pstream.call(null, function(h) {
      return a.call(null, h, b, c, d)
    })
  }, d = function(b, c, d, h) {
    var i = c.call(null, d, cljs.core.first.call(null, h)), j = cljs.core.rest.call(null, h);
    promise_stream.pstream.append_BANG_.call(null, b, i);
    return promise_stream.pcell.done.call(null, j, function(d) {
      return cljs.core.empty_QMARK_.call(null, d) ? promise_stream.pstream.close_BANG_.call(null, b) : a.call(null, b, c, i, j)
    })
  }, a = function(a, f, g, h) {
    switch(arguments.length) {
      case 2:
...
promise_stream.pstream.dorun_STAR_ = function(a) {
  cljs.core.reduce.call(null, function() {
    return jayq.core.$deferred.call(null)
  }, a);
  return null
};
promise_stream.pstream.doall_STAR_ = function(a) {
  return cljs.core.reduce.call(null, promise_stream.pstream.fmap.call(null, cljs.core.conj), promise_stream.pstream.promise.call(null, cljs.core.PersistentVector.EMPTY), a)
};
promise_stream.pstream.pstream_m = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:return", promise_stream.pstream.closed_pstream, "\ufdd0:bind", function(a, b) {
  return promise_stream.pstream.mapcat_STAR_.call(null, b, a)
}, "\ufdd0:zero", cljs.core.identity], !0);
promise_stream.sources = {};
promise_stream.sources.timestamp = function() {
  return(new Date).valueOf()
};
promise_stream.sources.metranome = function(a) {
  return promise_stream.pstream.with_open_pstream.call(null, function(b) {
    return window.setInterval(function() {
      return promise_stream.pstream.append_BANG_.call(null, b, promise_stream.pcell.deferred.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:time", promise_stream.sources.timestamp.call(null)], !0)))
    }, a)
  })
};
promise_stream.sources.event_stream = function(a, b) {
  return promise_stream.pstream.with_open_pstream.call(null, function(c) {
    return jayq.core.on.call(null, a, b, function(a) {
      a.preventDefault();
      return promise_stream.pstream.append_BANG_.call(null, c, promise_stream.pcell.deferred.call(null, a))
    })
  })
};
promise_stream.sources.callback__GT_promise_stream = function() {
  var a = function(a, b) {
    return promise_stream.pstream.with_open_pstream.call(null, function(e) {
      return cljs.core.apply.call(null, a, cljs.core.concat.call(null, b, cljs.core.list.call(null, function(a) {
        return promise_stream.pstream.append_BANG_.call(null, e, promise_stream.pcell.deferred.call(null, a))
      })))
    })
  }, b = function(b, d) {
    var e = null;
...
var extracting_processes = {core:{}};
extracting_processes.core.log = function(a) {
  return console.log(cljs.core.clj__GT_js.call(null, a))
};
extracting_processes.core.log_stream = function(a) {
  return promise_stream.pstream.mapd_STAR_.call(null, extracting_processes.core.log, a)
};
extracting_processes.core.IHighlightable = {};
extracting_processes.core._highlight_BANG_ = function(a, b) {
  var c;
  c = a ? a.extracting_processes$core$IHighlightable$_highlight_BANG_$arity$2 : a;
  if(c) {
    return a.extracting_processes$core$IHighlightable$_highlight_BANG_$arity$2(a, b)
  }
  c = extracting_processes.core._highlight_BANG_[goog.typeOf(null == a ? null : a)];
  if(!c && (c = extracting_processes.core._highlight_BANG_._, !c)) {
    throw cljs.core.missing_protocol.call(null, "IHighlightable.-highlight!", a);
  }
  return c.call(null, a, b)
};
extracting_processes.core._unhighlight_BANG_ = function(a, b) {
  var c;
  c = a ? a.extracting_processes$core$IHighlightable$_unhighlight_BANG_$arity$2 : a;
  if(c) {
    return a.extracting_processes$core$IHighlightable$_unhighlight_BANG_$arity$2(a, b)
  }
  c = extracting_processes.core._unhighlight_BANG_[goog.typeOf(null == a ? null : a)];
  if(!c && (c = extracting_processes.core._unhighlight_BANG_._, !c)) {
    throw cljs.core.missing_protocol.call(null, "IHighlightable.-unhighlight!", a);
  }
  return c.call(null, a, b)
};
extracting_processes.core.ISelectable = {};
extracting_processes.core._select_BANG_ = function(a, b) {
  var c;
  c = a ? a.extracting_processes$core$ISelectable$_select_BANG_$arity$2 : a;
  if(c) {
    return a.extracting_processes$core$ISelectable$_select_BANG_$arity$2(a, b)
  }
  c = extracting_processes.core._select_BANG_[goog.typeOf(null == a ? null : a)];
  if(!c && (c = extracting_processes.core._select_BANG_._, !c)) {
    throw cljs.core.missing_protocol.call(null, "ISelectable.-select!", a);
  }
  return c.call(null, a, b)
};
extracting_processes.core._unselect_BANG_ = function(a, b) {
  var c;
  c = a ? a.extracting_processes$core$ISelectable$_unselect_BANG_$arity$2 : a;
  if(c) {
    return a.extracting_processes$core$ISelectable$_unselect_BANG_$arity$2(a, b)
  }
  c = extracting_processes.core._unselect_BANG_[goog.typeOf(null == a ? null : a)];
  if(!c && (c = extracting_processes.core._unselect_BANG_._, !c)) {
    throw cljs.core.missing_protocol.call(null, "ISelectable.-unselect!", a);
  }
  return c.call(null, a, b)
};
extracting_processes.core.set_select_column = function(a, b, c) {
  return cljs.core.truth_(b) ? cljs.core.update_in.call(null, a, cljs.core.PersistentVector.fromArray([b], !0), function(a) {
    return clojure.string.replace.call(null, a, /^../, [cljs.core.str(" "), cljs.core.str(c)].join(""))
  }) : a
};
extracting_processes.core.set_highlight_column = function(a, b, c) {
  return cljs.core.update_in.call(null, a, cljs.core.PersistentVector.fromArray([b], !0), function(a) {
    return clojure.string.replace.call(null, a, /^./, c)
  })
};
extracting_processes.core.set_char_BANG_ = function(a, b, c) {
  return[cljs.core.str(a.substring(0, b)), cljs.core.str(c), cljs.core.str(a.substring(b + 1))].join("")
};
extracting_processes.core.ISelectable.array = !0;
extracting_processes.core._select_BANG_.array = function(a, b) {
  extracting_processes.core.log.call(null, b);
  extracting_processes.core.log.call(null, a[b]);
  a[b] = extracting_processes.core.set_char_BANG_.call(null, a[b], 1, "*");
  return a
};
extracting_processes.core._unselect_BANG_.array = function(a, b) {
  a[b] = extracting_processes.core.set_char_BANG_.call(null, a[b], 1, " ");
  return a
};
extracting_processes.core.IHighlightable.array = !0;
extracting_processes.core._highlight_BANG_.array = function(a, b) {
  a[b] = extracting_processes.core.set_char_BANG_.call(null, a[b], 0, ">");
  return a
};
extracting_processes.core._unhighlight_BANG_.array = function(a, b) {
  a[b] = extracting_processes.core.set_char_BANG_.call(null, a[b], 0, " ");
  return a
};
HTMLUListElement.prototype.extracting_processes$core$ISelectable$ = !0;
HTMLUListElement.prototype.extracting_processes$core$ISelectable$_select_BANG_$arity$2 = function(a, b) {
  dom.add_class_BANG_.call(null, cljs.core.nth.call(null, dom.by_tag_name.call(null, a, "li"), b), "selected");
  return a
};
HTMLUListElement.prototype.extracting_processes$core$ISelectable$_unselect_BANG_$arity$2 = function(a, b) {
  dom.remove_class_BANG_.call(null, cljs.core.nth.call(null, dom.by_tag_name.call(null, a, "li"), b), "selected");
  return a
};
HTMLUListElement.prototype.extracting_processes$core$IHighlightable$ = !0;
HTMLUListElement.prototype.extracting_processes$core$IHighlightable$_highlight_BANG_$arity$2 = function(a, b) {
  dom.add_class_BANG_.call(null, cljs.core.nth.call(null, dom.by_tag_name.call(null, a, "li"), b), "highlighted");
  return a
};
HTMLUListElement.prototype.extracting_processes$core$IHighlightable$_unhighlight_BANG_$arity$2 = function(a, b) {
  dom.remove_class_BANG_.call(null, cljs.core.nth.call(null, dom.by_tag_name.call(null, a, "li"), b), "highlighted");
  return a
};
HTMLUListElement.prototype.cljs$core$ICounted$ = !0;
HTMLUListElement.prototype.cljs$core$ICounted$_count$arity$1 = function(a) {
  return cljs.core.count.call(null, dom.by_tag_name.call(null, a, "li"))
};
extracting_processes.core.keycode__GT_key = cljs.core.PersistentArrayMap.fromArray([38, "\ufdd0:up", 40, "\ufdd0:down", 74, "\ufdd0:j", 75, "\ufdd0:k", 13, "\ufdd0:enter"], !0);
extracting_processes.core.key__GT_action = cljs.core.PersistentArrayMap.fromArray("\ufdd0:up \ufdd0:highlight/previous \ufdd0:down \ufdd0:highlight/next \ufdd0:j \ufdd0:highlight/next \ufdd0:k \ufdd0:highlight/previous \ufdd0:enter \ufdd0:select/current".split(" "), !0);
extracting_processes.core.highlight_actions = cljs.core.PersistentHashSet.fromArray(["\ufdd0:highlight/next", null, "\ufdd0:highlight/previous", null], !0);
extracting_processes.core.select_actions = cljs.core.PersistentHashSet.fromArray(["\ufdd0:select/current", null], !0);
extracting_processes.core.highlight_action__GT_offset = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:highlight/previous", cljs.core.dec, "\ufdd0:highlight/next", cljs.core.inc], !0);
...
extracting_processes.core.first_state = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:highlight", 0, "\ufdd0:selection", null], !0);
extracting_processes.core.remember_selection = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  cljs.core.get.call(null, c, "\ufdd0:selection");
  var d = cljs.core.get.call(null, c, "\ufdd0:highlight");
  return cljs.core._EQ_.call(null, b, "\ufdd0:select/current") ? cljs.core.assoc.call(null, c, "\ufdd0:selection", d) : cljs.core.assoc.call(null, c, "\ufdd0:highlight", b)
};
extracting_processes.core.render_ui = function(a, b) {
  var c = cljs.core.seq_QMARK_.call(null, b) ? cljs.core.apply.call(null, cljs.core.hash_map, b) : b, d = cljs.core.get.call(null, c, "\ufdd0:selection"), c = cljs.core.get.call(null, c, "\ufdd0:highlight");
  cljs.core.truth_(d) && extracting_processes.core._select_BANG_.call(null, a, d);
  extracting_processes.core._highlight_BANG_.call(null, a, c);
  return clojure.string.join.call(null, "\n", a)
};
extracting_processes.core.identify_key_actions = function(a) {
...
extracting_processes.core.mouseover__GT_highlight = function(a) {
  return jayq.core.$.call(null, a.target).index()
};
extracting_processes.core.load_example = function(a) {
  var b = cljs.core.count.call(null, a), c = promise_stream.sources.callback__GT_promise_stream.call(null, jayq.core.on, jayq.core.$.call(null, "div"), "keydown"), d = promise_stream.sources.callback__GT_promise_stream.call(null, jayq.core.on, jayq.core.$.call(null, "li"), "mouseover"), e = promise_stream.sources.callback__GT_promise_stream.call(null, jayq.core.on, jayq.core.$.call(null, "ul"), "mouseout"), f = promise_stream.sources.callback__GT_promise_stream.call(null, jayq.core.on, jayq.core.$.call(null, 
  "li"), "click"), g = extracting_processes.core.identify_key_actions.call(null, c), h = promise_stream.pstream.filter_STAR_.call(null, cljs.core.comp.call(null, promise_stream.pstream.promise, extracting_processes.core.select_actions), g), i = promise_stream.pstream.mapd_STAR_.call(null, cljs.core.constantly.call(null, "\ufdd0:select"), f), j = promise_stream.pstream.concat_STAR_.call(null, h, i), l = promise_stream.pstream.filter_STAR_.call(null, cljs.core.comp.call(null, promise_stream.pstream.promise, 
  extracting_processes.core.highlight_actions), g), m = promise_stream.pstream.mapd_STAR_.call(null, extracting_processes.core.mouseover__GT_highlight, d), k = promise_stream.pstream.mapd_STAR_.call(null, cljs.core.constantly.call(null, "\ufdd0:clear"), e), n = promise_stream.pstream.mapd_STAR_.call(null, extracting_processes.core.highlight_action__GT_offset, l), p = promise_stream.pstream.mapd_STAR_.call(null, cljs.core.constantly, m), q = promise_stream.pstream.concat_STAR_.call(null, n, p), r = 
  promise_stream.pstream.reductions_STAR_.call(null, promise_stream.pstream.fmap.call(null, function(a, b) {
    return b.call(null, a)
  }), promise_stream.pstream.promise.call(null, 0), q), b = promise_stream.pstream.mapd_STAR_.call(null, function(a) {
    return function(b) {
      return cljs.core.mod.call(null, b, a)
    }
  }(b, c, d, e, f, g, h, i, j, l, m, k, n, p, q, r), r), j = promise_stream.pstream.concat_STAR_.call(null, b, j), j = promise_stream.pstream.reductions_STAR_.call(null, promise_stream.pstream.fmap.call(null, extracting_processes.core.remember_selection), promise_stream.pstream.promise.call(null, extracting_processes.core.first_state), j), a = promise_stream.pstream.mapd_STAR_.call(null, cljs.core.partial.call(null, extracting_processes.core.render_ui, a), j);
  extracting_processes.core.log_stream.call(null, j);
  return a
};
promise_stream.pstream.mapd_STAR_.call(null, function(a) {
  return jayq.core.text.call(null, jayq.core.$.call(null, "#ex0"), a)
